...
import TaskAltIcon from '@mui/icons-material/BookmarkAdded';
    ...
    const features = [
      {
        ...
        icon: <ListAltRoundedIcon className="text-blue-600 text-[32px]" />,
      ...
      },
      {
        ...
        icon: <DevicesRoundedIcon className="text-blue-600 text-[32px]" />,
      ...
      },
      {
        ...
        icon: <SortRoundedIcon className="text-blue-600 text-[32px]" />,
        ...
        <div className=" mx-auto px-4 ">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10 px-10 ">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full items-center justify-center flex bg-blue-100">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-semibold text-blue-600 mt-6 text-center">
                  {feature.name}
                </h3>
  ...
  function CTASection() {
    return (
      <div className="flex flex-col mx-16 items-center mt-[120px] gap-6 ">
        ...
        <button
          className={`block bg-blue-300 rounded-md  px-9 py-3 text-sm font-medium text-white hover:bg-blue-600    `}
          type="button"
        >
          {`Let's get started!`}
        </button>
...
function Navbar() {
  ...
  function Logo() {
    return (
      <div className="flex gap-2 items-center">
        ...
        <TaskAltIcon sx={{ fontSize: 34 }} className="text-blue-600  " />

        {/* App Name */}
        <div className="flex gap-1 text-[22px] ">
          <span className={`font-bold text-blue-600`}>My</span>
      ...
      <div className="flex gap-2 max-sm:flex-col max-sm:w-full max-sm:mt-8">
        {!userId ? (
          <>
            <Link href="/sign-in">
              <button
                className={` max-sm:w-full text-sm border border-blue-600 text-white bg-blue-600 
 p-[8px] px-6 rounded-md `}
            ...
            <Link href="/sign-up">
              <button
                className={` max-sm:w-full text-sm border border-blue-600 text-blue-600 
hover:bg-blue-600 hover:text-white p-[8px] px-6 rounded-md `}
              >
                Sign Up
              </button>
            </Link>
          ...
          <Link href="/dashboard">
            <button
              className={` max-sm:w-full text-sm border bg-blue-600 text-white
hover:bg-blue-600 hover:text-white p-[8px] px-6 rounded-md `}
            >
              Dashboard
            </button>
